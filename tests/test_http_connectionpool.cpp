...
void test_http_pool()
{
    auto pool = std::make_shared<lon::httpservice::HttpConnectionPool>("127.0.0.1", "", 8080, false,
                                                                       10, 30000, 3);
...
void test_https_pool()
{
    auto pool =
        lon::httpservice::HttpConnectionPool::create("https://www.baidu.com/", "", 10, 30000, 3);
